        ...
        <div class="content">
            <div>
                ...
                <p class="button-text intro-content">
                    ...
                    хантят в первую очередь, как составить продающее резюме и как влюбить в
                    себя всех на собеседовании
                </p>
            </div>
        ...
        <div class="content align-center">
            ...
            <div class="tickets-wrapper mobile-hide">
                ...
                >
                    ...
                    <p class="no-margin ticket-caption">
                        Эксперты расскажут, почему организация школьного бала и статус «старосты» уже классный опыт, который можно указать в резюме, а также поделятся лайфхаками, как получить необходимые компетенции для старта карьеры.
                    </p>
                </Ticket>
                <Ticket
